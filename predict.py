...
def predict_unseen_data():
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            logging.critical("params {}".format(params))
            cnn_rnn = TextCNNRNN(
            ...
            checkpoint_file = trained_dir + 'model'
            saver = tf.train.Saver(tf.all_variables())
            saver = tf.train.import_meta_graph(trained_dir + 'model.meta')  # "{}.meta".format(checkpoint_file[:-5]))
